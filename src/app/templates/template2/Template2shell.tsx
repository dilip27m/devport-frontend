...
import Header, { SectionId } from "@/app/templates/template2/components/Header";
import PortfolioView from "@/app/templates/template2/sections/PortfolioView";
import ProjectsView from "@/app/templates/template2/sections/ProjectsView";
import SkillsView from "@/app/templates/template2/sections/SkillsView";
import BlogsView from "@/app/templates/template2/sections/BlogsView";
  ...
  achievements: [
    {
      ...
      year: "2023",
      image: "/images/achievement1.jpeg"
    },
    {
...
const Template2Shell: React.FC<{ data: PortfolioData }> = ({ data }) => {
