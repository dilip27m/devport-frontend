    ...
    <div className="min-h-screen">
      ...
      <section className="relative px-4 pt-20 pb-24">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          {bioDisplay && (
            <div className="mb-8">
              <p className="text-sm md:text-base text-gray-400 text-center max-w-4xl mx-auto">
                {bioDisplay}
              </p>
            </div>
          )}
      ...
      <section className="relative max-w-7xl mx-auto px-4 pb-32 pt-8">
        <div className="flex items-start">
          ...
          <div className="hidden lg:flex relative flex-shrink-0 items-start pt-8">
            ...
            <div className="absolute top-0 right-8 grid grid-cols-6 gap-3 opacity-30 z-0">
