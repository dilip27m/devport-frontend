    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {(blogs || []).map((blog, i) => (
        <a 
          ...
          key={i} 
          className="group block bg-gradient-to-br from-gray-900/80 to-gray-950/80 border border-gray-800/50 rounded-2xl overflow-hidden hover:border-gray-700 hover:shadow-2xl hover:shadow-purple-500/10 transition-all duration-300"
        >
          {/* Blog Image */}
          {blog.image ? (
            <div className="relative h-56 overflow-hidden bg-gradient-to-br from-gray-950 to-black">
              <img 
                src={blog.image} 
                alt={blog.name} 
            ...
            <div className="relative h-56 bg-gradient-to-br from-gray-950 to-black flex items-center justify-center">
          ...
          {/* Blog Content */}
          <div className="p-6">
            <h3 className="text-lg font-bold text-white group-hover:text-blue-400 transition-colors leading-snug line-clamp-2 mb-2">
              {blog.name}
            </h3>
