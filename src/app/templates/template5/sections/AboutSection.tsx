    ...
    <section className="py-12 sm:py-20 px-4 sm:px-6 max-w-6xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
        ...
        <BubbleCard className="h-full flex flex-col justify-center bg-gradient-to-br from-zinc-900 to-black border-zinc-800">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-yellow-400">About Me</h2>

          <p className="text-zinc-300 leading-relaxed text-base sm:text-lg whitespace-pre-wrap">
            {aboutMe.aboutMe || aboutMe.bio || "No description added yet."}
          </p>
        </BubbleCard>

        {/* Photo/Decorative Card */}
        <BubbleCard className="min-h-[250px] sm:min-h-[300px] flex items-center justify-center bg-zinc-900 text-white overflow-hidden relative border-zinc-800">
          {aboutMe.photo ? (
            <>
              <img
                src={aboutMe.photo}
            ...
            <>
              ...
              <div className="z-10 text-center px-4 sm:px-6">
                <p className="text-xl sm:text-2xl font-light italic text-yellow-100">"Designing the future,<br /> one pixel at a time."</p>
              </div>
            </>
          )}
        </BubbleCard>
